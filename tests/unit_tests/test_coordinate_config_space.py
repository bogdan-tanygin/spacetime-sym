...
class CoordinateConfigSpaceTestCase( unittest.TestCase ):
    ...
    @patch( "spacetime.coordinate_config_space.ConfigurationSpace.__init__" )
    ...
    @patch( "spacetime.coordinate_config_space.ConfigurationSpace.__init__", new=mock_configuration_space_init )
