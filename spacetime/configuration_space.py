...
from spacetime.permutations import flatten_list, unique_permutations, number_of_unique_permutations
from spacetime import Configuration, SymmetryGroup, SymmetryOperation
import numpy as np
...
class ConfigurationSpace:
    ...
    def __init__( self, objects, symmetry_group=None ):
        ...
        if symmetry_group:
            ...
            self.symmetry_group = SymmetryGroup( symmetry_operations=[ SymmetryOperation( np.identity( self.dim, dtype = float ), label='E' ) ] )
